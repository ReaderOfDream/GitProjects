...
namespace ManagementCompany.Themes
{
    ...
    public partial class CustomWindow : Window
    {
        ...
        private void AttachLeftBorder()
        {
            if (LeftBorder != null)
            {
                LeftBorder.AddHandler(UIElement.MouseLeftButtonDownEvent,
                                      new MouseButtonEventHandler(OnBorderMouseLeftButtonDown));
                LeftBorder.AddHandler(UIElement.MouseLeftButtonUpEvent,
                                      new MouseButtonEventHandler(OnBorderMouseLeftButtonUp));
        ...
        private void AttachRightBorder()
        {
            if (RightBorder != null)
            {
                RightBorder.AddHandler(UIElement.MouseLeftButtonDownEvent,
                                       new MouseButtonEventHandler(OnBorderMouseLeftButtonDown));
                RightBorder.AddHandler(UIElement.MouseLeftButtonUpEvent,
                                       new MouseButtonEventHandler(OnBorderMouseLeftButtonUp));
        ...
        private void AttachTopBorder()
        {
            if (TopBorder != null)
            {
                TopBorder.AddHandler(UIElement.MouseLeftButtonDownEvent,
                                     new MouseButtonEventHandler(OnBorderMouseLeftButtonDown));
                TopBorder.AddHandler(UIElement.MouseLeftButtonUpEvent,
                                     new MouseButtonEventHandler(OnBorderMouseLeftButtonUp));
        ...
        private void AttachBottomBorder()
        {
            ...
            {
                BottomBorder.AddHandler(UIElement.MouseLeftButtonDownEvent,
                                        new MouseButtonEventHandler(OnBorderMouseLeftButtonDown));
                BottomBorder.AddHandler(UIElement.MouseLeftButtonUpEvent,
                                        new MouseButtonEventHandler(OnBorderMouseLeftButtonUp));
